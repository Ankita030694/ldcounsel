    ...
    <div className="min-h-screen bg-[#F8F1E6]">
      ...
      <section className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          ...
          <div className="bg-[#F8F1E6] rounded-xl p-8 sm:p-12 lg:p-16 mb-12 lg:mb-16 border border-[#102028]/10 shadow-sm">
            <div className="max-w-6xl mx-auto">
              <div className="prose prose-lg lg:prose-xl max-w-none">
                ...
                <p className="text-[#102028] text-lg lg:text-xl xl:text-2xl leading-relaxed">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#102028] opacity-80 text-sm lg:text-base">Represented clients in multi-crore commercial disputes, sensitive matrimonial cases, and landmark service law matters.</p>
                    </div>
                  </div>
                </div>
                <div className="space-y-4">
          ...
          <div className="bg-gradient-to-br from-[#102028] via-[#102028] to-[#1a2a3a] rounded-xl p-8 sm:p-12 lg:p-16 mb-12 lg:mb-16 text-[#F8F1E6] relative overflow-hidden">
            {/* Background Pattern */}
            <div className="absolute inset-0 opacity-5">
              <div className="absolute inset-0" style={{
                backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23F8F1E6' fill-opacity='0.1'%3E%3Ccircle cx='30' cy='30' r='2'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
              }}></div>
            </div>
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              ...
              <div className="text-center mb-16 lg:mb-20">
                <div className="inline-flex items-center justify-center w-16 h-16 lg:w-20 lg:h-20 bg-[#F8F1E6]/10 rounded-full mb-6 lg:mb-8">
                  <svg className="w-8 h-8 lg:w-10 lg:h-10 text-[#F8F1E6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <h2 className="font-playfair text-3xl sm:text-4xl lg:text-5xl xl:text-6xl mb-6 lg:mb-8">
                  Our Litigation Expertise
                </h2>
                <p className="text-[#F8F1E6] text-lg lg:text-xl xl:text-2xl opacity-90 max-w-4xl mx-auto leading-relaxed">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div className="group relative">
                  <div className="bg-gradient-to-br from-[#F8F1E6]/10 to-[#F8F1E6]/5 backdrop-blur-sm rounded-2xl p-8 lg:p-10 border border-[#F8F1E6]/20 hover:border-[#F8F1E6]/40 transition-all duration-500 hover:shadow-2xl hover:shadow-[#F8F1E6]/10 hover:-translate-y-2">
                    <div className="flex items-start justify-between mb-6">
                      <div className="flex items-center">
                        <div className="w-14 h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-[#F8F1E6]/20 to-[#F8F1E6]/10 rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                          <svg className="w-7 h-7 lg:w-8 lg:h-8 text-[#F8F1E6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                          </svg>
                        </div>
                        <div>
                          <h3 className="font-playfair text-[#F8F1E6] text-2xl lg:text-3xl xl:text-4xl mb-2">Civil Litigation</h3>
                          <p className="text-[#F8F1E6] opacity-70 text-sm lg:text-base">Property & Contract Disputes</p>
                        </div>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div className="flex items-center space-x-3 group/item">
                        <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                        <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">Property disputes, injunctions, recovery suits</span>
                      </div>
                      <div className="flex items-center space-x-3 group/item">
                        <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                        <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">Breach of contract and partnership disagreements</span>
                      </div>
                      <div className="flex items-center space-x-3 group/item">
                        <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                        <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">Consumer protection and defective goods/services disputes</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-gradient-to-br from-[#F8F1E6]/10 to-[#F8F1E6]/5 backdrop-blur-sm rounded-2xl p-8 lg:p-10 border border-[#F8F1E6]/20 hover:border-[#F8F1E6]/40 transition-all duration-500 hover:shadow-2xl hover:shadow-[#F8F1E6]/10 hover:-translate-y-2">
                    <div className="flex items-start justify-between mb-6">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h3 className="font-playfair text-[#F8F1E6] text-2xl lg:text-3xl xl:text-4xl mb-2">Criminal Litigation</h3>
                          <p className="text-[#F8F1E6] opacity-70 text-sm lg:text-base">Defense & Prosecution</p>
                        </div>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div className="flex items-center space-x-3 group/item">
                        <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                        <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">Bail applications, criminal trials, and appeals</span>
                      </div>
                      <div className="flex items-center space-x-3 group/item">
                        <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                        <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">White-collar crimes and fraud-related prosecutions</span>
                      </div>
                      <div className="flex items-center space-x-3 group/item">
                        <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                        <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">Cheque bounce and financial offence cases</span>
                      </div>
                      <div className="flex items-center space-x-3 group/item">
                        <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                        <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">NDPS Act Matters & IT Act cases</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-gradient-to-br from-[#F8F1E6]/10 to-[#F8F1E6]/5 backdrop-blur-sm rounded-2xl p-8 lg:p-10 border border-[#F8F1E6]/20 hover:border-[#F8F1E6]/40 transition-all duration-500 hover:shadow-2xl hover:shadow-[#F8F1E6]/10 hover:-translate-y-2">
                    <div className="flex items-start justify-between mb-6">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h3 className="font-playfair text-[#F8F1E6] text-2xl lg:text-3xl xl:text-4xl mb-2">Commercial Disputes</h3>
                          <p className="text-[#F8F1E6] opacity-70 text-sm lg:text-base">Corporate & Business Law</p>
                        </div>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div className="flex items-center space-x-3 group/item">
                        <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                        <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">High-value corporate litigation and shareholder disputes</span>
                      </div>
                      <div className="flex items-center space-x-3 group/item">
                        <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                        <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">Breach of business agreements and non-compete violations</span>
                      </div>
                      <div className="flex items-center space-x-3 group/item">
                        <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                        <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">Debt recovery and enforcement of contractual rights</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-gradient-to-br from-[#F8F1E6]/10 to-[#F8F1E6]/5 backdrop-blur-sm rounded-2xl p-8 lg:p-10 border border-[#F8F1E6]/20 hover:border-[#F8F1E6]/40 transition-all duration-500 hover:shadow-2xl hover:shadow-[#F8F1E6]/10 hover:-translate-y-2">
                    <div className="flex items-start justify-between mb-6">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h3 className="font-playfair text-[#F8F1E6] text-2xl lg:text-3xl xl:text-4xl mb-2">Service Law Matters</h3>
                          <p className="text-[#F8F1E6] opacity-70 text-sm lg:text-base">Employment & Labor Law</p>
                        </div>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div className="flex items-center space-x-3 group/item">
                        <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                        <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">Illegal termination or suspension challenges</span>
                      </div>
                      <div className="flex items-center space-x-3 group/item">
                        <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                        <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">Pay scale, promotion, and pension disputes</span>
                      </div>
                      <div className="flex items-center space-x-3 group/item">
                        <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                        <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">Representation before CAT and service tribunals</span>
                      </div>
                      <div className="flex items-center space-x-3 group/item">
                        <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                        <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">Debt recovery and enforcement of contractual rights</span>
                  ...
                  <div className="bg-gradient-to-br from-[#F8F1E6]/10 to-[#F8F1E6]/5 backdrop-blur-sm rounded-2xl p-8 lg:p-10 border border-[#F8F1E6]/20 hover:border-[#F8F1E6]/40 transition-all duration-500 hover:shadow-2xl hover:shadow-[#F8F1E6]/10 hover:-translate-y-2">
                    <div className="flex items-start justify-between mb-6">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h3 className="font-playfair text-[#F8F1E6] text-2xl lg:text-3xl xl:text-4xl mb-2">Specialised Tribunals</h3>
                          <p className="text-[#F8F1E6] opacity-70 text-sm lg:text-base">Expert Representation Across All Forums</p>
                        </div>
                      </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="space-y-4">
                        <div className="flex items-center space-x-3 group/item">
                          <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                          <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">NCLT/NCLAT for company law matters</span>
                        </div>
                        <div className="flex items-center space-x-3 group/item">
                          <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                          <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">Consumer Commissions for consumer rights enforcement</span>
                        </div>
                      </div>
                      <div className="space-y-4">
                        <div className="flex items-center space-x-3 group/item">
                          <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                          <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">Debt Recovery Tribunals for banking and finance disputes</span>
                        </div>
                        <div className="flex items-center space-x-3 group/item">
                          <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                          <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">Criminal appeals before High Courts and Supreme Court</span>
                        </div>
                      </div>
                      <div className="space-y-4">
                        <div className="flex items-center space-x-3 group/item">
                          <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                          <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">Special Leave Petitions (SLPs) challenging High Court orders</span>
                        </div>
                        <div className="flex items-center space-x-3 group/item">
                          <div className="w-2 h-2 bg-[#F8F1E6] rounded-full group-hover/item:scale-150 transition-transform duration-200"></div>
                          <span className="text-[#F8F1E6] text-sm lg:text-base opacity-90 group-hover/item:opacity-100 transition-opacity duration-200">IT Act cases including hacking, phishing, and online defamation</span>
                        </div>
                      </div>
                    </div>
                  </div>
